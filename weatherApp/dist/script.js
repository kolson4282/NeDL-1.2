...
function createWeeklyForecast(city) {
...
function createHourlyForecast(city) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield fetch(`${baseURL}/${city.office}/${city.gridX},${city.gridY}/forecast/hourly`);
        const forecast = yield result.json();
